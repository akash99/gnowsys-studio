...
urlpatterns = patterns(
    ...
    url(r'^comeon/', include('gstudio.urls.doit')),
    url(r'^video/', include('gstudio.urls.exe')),
	url(r'^qaz/', include('gstudio.urls.qaz')),
    url(r'^views1/', include('gstudio.urls.new')),
    url(r'^tmp/', include('gstudio.urls.wer')),
